...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps
            .Where(e => chicDepts.Contains(e.DeptNo))
            .ToList();
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = emps
            .SelectMany( e => e.EName, (e, c) => new {EName = e.EName, Comm = e.Comm} )
            .Where(e => e.Comm != null)
            .ToList();
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps
            ...
            .Where(x => x.Salary >= x.Losal && x.Salary <= x.Hisal)
